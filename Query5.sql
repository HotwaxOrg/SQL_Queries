...
oh2.EXTERNAL_ID , f.FACILITY_ID, f.PRODUCT_STORE_ID  , f.FACILITY_TYPE_ID , 
...
join order_item_ship_group oisg on oisg.ORDER_ID = oh.ORDER_ID and oisg.SHIP_GROUP_SEQ_ID = oh.SHIP_GROUP_SEQ_ID 
