...
select  oh.order_id, oh.status_id, oh.order_date, or2.PARTY_ID,  or2.ROLE_TYPE_ID, p.FIRST_NAME ,
p.LAST_NAME , pa.ADDRESS1 , pa.ADDRESS2 , pa.CITY , pa.STATE_PROVINCE_GEO_ID , pa.POSTAL_CODE ,
pa.COUNTRY_GEO_ID 
